...
class AuditorReviewTable extends React.Component {
    ...
    showInfoAuditorReview = (idAuditorReview, idUserAuditorReview, idRefugeAuditorReview, idRefugeAbilityAuditorReview, scoreAuditorReview) => {
        this.setState({
            id: idAuditorReview,
...
<TextValidator
    ...
    value={this.state.idRefugeAbility}
    validators={['required']}
    errorMessages={['This field is required']}
/>
<TextValidator
