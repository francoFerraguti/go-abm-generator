...
class PetPhoto extends React.Component {
    constructor(props) {
        ...
        this._handleChangeIdPet = this._handleChangeIdPet.bind(this);
this._handleChangeIdPhoto = this._handleChangeIdPhoto.bind(this);
...
idPhoto: this.state.idPhoto,
    ...
    _handleChangeIdPet = (event) => {
    const target = event.target
    const value = target.value
    const name = target.name

    this.setState({
        idPet: parseInt(value)
    });
};
_handleChangeIdPhoto = (event) => {
    const target = event.target
    const value = target.value
    const name = target.name

    this.setState({
        idPhoto: parseInt(value)
    });
};
    ...
    onChange={this._handleChangeIdPet}
    name='idPet'
    value={this.state.form.idPet}
/>
<TextValidator
    floatingLabelText='IdPhoto'
    onChange={this._handleChangeIdPhoto}
    name='idPhoto'
